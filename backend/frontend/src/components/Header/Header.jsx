...
//           <li>
//         <a href="/" class="block text-base font-medium text-gray-500 hover:text-gray-900 md:flex-col">Home</a>
//         </li>
//         <li>
//         <a href="http://localhost:3000/jobs" class="block text-base font-medium text-gray-500 md:flex-col hover:text-gray-900">Jobs</a>
//         </li>
//         <li>
//         <a href="http://localhost:3000/" class=" block text-base font-medium text-gray-500 md:flex-col hover:text-gray-900">Candidates</a>  
//         </li>
//         </ul>
//       </nav> */}
...
<nav class="bg-white px-2 sm:px-4 py-2.5 dark:bg-gray-900 fixed w-full z-20 top-0 left-0 border-b border-gray-200 dark:border-gray-600">
  ...
  <a href="http://localhost:3000" class="flex items-center">
      <img src="https://flowbite.com/docs/images/logo.svg" class="h-6 mr-3 sm:h-9" alt="Flowbite Logo" />
      <span class="self-center text-xl font-semibold whitespace-nowrap dark:text-white">ARJ</span>
  </a>
  <div class="flex md:order-2">
      ...
      <button data-collapse-toggle="navbar-sticky" onClick={myFunction()} type="button" class="inline-flex items-center p-2 text-sm text-gray-500 rounded-lg md:hidden hover:bg-gray-100 focus:outline-none focus:ring-2 focus:ring-gray-200 dark:text-gray-400 dark:hover:bg-gray-700 dark:focus:ring-gray-600" aria-controls="navbar-sticky" aria-expanded="false" id='myDropdown'>
        <span class="sr-only">Open main menu</span>
        <svg class="w-6 h-6" aria-hidden="true" fill="currentColor" viewBox="0 0 20 20" xmlns="http://www.w3.org/2000/svg"><path fill-rule="evenodd" d="M3 5a1 1 0 011-1h12a1 1 0 110 2H4a1 1 0 01-1-1zM3 10a1 1 0 011-1h12a1 1 0 110 2H4a1 1 0 01-1-1zM3 15a1 1 0 011-1h12a1 1 0 110 2H4a1 1 0 01-1-1z" clip-rule="evenodd"></path></svg>
    </button>
  </div>
