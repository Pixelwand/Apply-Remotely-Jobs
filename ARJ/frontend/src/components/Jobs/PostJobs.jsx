...
export const PostJobs = () => {
  ...
  const formSubmit = async (data) => {
    await fetch("https://apply-remote-jobs.onrender.com/user/postjob", {
      method: "POST",
      headers: {
    ...
    <>
      <div className="w-full pb-20">
        <form onSubmit={handleSubmit(formSubmit)}>
          <div className="text-black pt-3 mb-8 w-full font-sans ">
            <div className="text-2xl font-bold text-center">
              Post Remote Jobs <span className="line-through">399$</span> 0$
            </div>
            <div className="text-xl text-white bg-red-500 leading-10 mt-2 text-center">
              100% Discount
            </div>
          </div>
          ...
          <div className="mb-8 font-xl w-full text-center">
            <label>
              <input
                ...
                name="companyName"
                type={"text"}
                className="outline outline-2 outline-offset-1 outline-blue-500 focus:outline-4 w-5/6 h-12 placeholder:text-black placeholder:text-lg text-lg rounded-lg pl-5 placeholder:font-sans"
          ...
          <div className="mb-8 text-center">
            <label>
              <input
                onChange={changeHandler}
                name="companyEmail"
                className="w-5/6 h-12 pl-5 outline outline-2 outline-offset-1  outline-blue-500 focus:outline-4 placeholder:text-black placeholder:text-lg text-lg rounded-lg"
                type={"text"}
          ...
          <div className="mb-8 font-xl text-center">
            <label>
              <input
                onChange={changeHandler}
                name="position"
                type={"text"}
                className="outline w-5/6 h-12 pl-6 outline-2 outline-offset-1 outline-blue-500 focus:outline-4 placeholder:text-black placeholder:text-lg text-lg rounded-lg placeholder:font-sans"
            ...
            </label>
            {
              <p className="text-xs mt-2 px-10">
                Please specify as single job position like `Marketing Manger``
                or `Node JS Developer``
          ...
          <div className="w-2/3 mx-auto">
            <Controller
              ...
              control={control}
              render={({ field }) => (
                <Select placeholder="Job Type" {...field} options={jobtype} />
              )}
            />
          </div>
          ...
          <div>
            ...
            <div className="flex flex-row gap-8 text-xl justify-center my-10">
              <Controller
                name="minSalary"
                control={control}
                render={({ field }) => <Select {...field} options={salary} />}
              />
              <Controller
                name="maxSalary"
                control={control}
            ...
            <div className="mb-5">
              <p className="text-xs px-10">
                ...
                If it`s a short-term gig, use the annual full-time equivalent.
                ...
                remote work. Remote OK is a supporter of #OpenSalaries.
              </p>
            </div>
          </div>

          <div className="mb-8 font-2xl font-bold ml-10">Job Description*:</div>
          <div>
            <label>
              <textarea
                onChange={changeHandler}
                name="JobDescription"
                type={"textarea"}
                className="outline outline-2 outline-offset-1 outline-blue-500 focus:outline-4 placeholder:text-black rounded-lg block w-5/6 mx-10 pt-3 h-72 mt-5 pl-5 placeholder:font-sans xl:mx-auto"
                placeholder="Mention All the details about job"
          ...
          <div>
            <div className="font-bold text-xl bg-red-500 text-white py-3 text-center">
              How to Apply?
            </div>
            <div>
              <textarea
                type={"textarea"}
                onChange={changeHandler}
                className="outline outline-2 outline-offset-1 outline-blue-500 placeholder:text-black pt-2 mx-auto focus:outline-4 rounded-lg block w-5/6 mb-10 h-72 mt-10 pl-5 placeholder:font-sans"
                name="howtoapply"
            ...
            <div>
              ...
              <input
                ...
                className="outline outline-2 mb-10 outline-offset-1 outline-blue-500 focus:outline-4 rounded-lg block w-4/6 mx-auto h-10 mt-5 pl-3 placeholder:font-sans"
                name="applyUrl"
          ...
          <div className="mb-8">
            ...
            <div className="text-center">
              <input
                ...
                onChange={changeHandler}
                className="w-4/6 h-10 pl-5 outline outline-2 outline-offset-1 mx-auto outline-blue-500 focus:outline-4 placeholder:text-black rounded-lg"
                placeholder="Twitter Username"
                type={"text"}
                {...register("twitterUsername", { required: true })}
              />
            </div>
            <p className="text-xs mt-2 px-10 text-center">
          ...
          <div className="mb-5">
            <div className="text-center">
              <input
                name="secondEmail"
                onChange={changeHandler}
                className="w-4/6 h-10 pl-5 outline outline-2 outline-offset-1 mx-auto outline-blue-500 rounded-lg"
                type={"email"}
                placeholder="Company Email"
                {...register("secondEmail", { required: true })}
              />
            </div>
            <p className="text-xs mt-2 text-center px-10">
          ...
          <div className="text-center w-full">
            <button
              className="bg-blue-600 hover:bg-blue-800 text-white font-semibold text-xl rounded px-6 py-3"
              type="submit"
            >
              Start Hiring at 0$
            </button>
