...
export default function Work() {
  return (
    <>
    <div class="bg-blue-900 text-white font-sans">
        <div class="flex justify-center gap-60 flex-row max-w-7xl mx-auto px-28 py-12">
            <div class="basis-1/2 font-bold text-5xl">Ways to work with us</div>
              <div>
            <button class="basis-1/2 bg-blue-600 px-8 py-4 hover:bg-blue-500">Get Started</button>
            </div>
        </div>
        <div class="pb-10">
