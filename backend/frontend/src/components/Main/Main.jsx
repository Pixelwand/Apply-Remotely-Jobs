        ...
        <div className="bg-indigo-900 text-white pt-10 pb-20">
          ...
          <div className="text-center mt-10">
            <span className="mr-5 sm:mr-10">
             <a href='https://kriyax.vercel.app/postjobs' className='bg-green-600 p-4 rounded-xl font-bold font-sans sm:text-2xl'>Post Remote Jobs </a>
            </span>
            <a href='https://kriyax.vercel.app/jobs' className='bg-green-600 p-4 rounded-xl font-bold font-sans sm:text-2xl'>Find Remote Jobs</a>
          </div>
          </div>
