            ...
            <div className="space-y-4">
              <nav className="flex-1 space-y-2">
                <a
                  href="#"
                  title=""
                  className="flex items-center px-4 py-2.5 text-sm font-medium text-black transition-all duration-200 bg-white rounded-lg group"
                >
                  <svg
                ...
                <a
                  href="#"
                  className="flex items-center px-4 py-2.5 text-sm font-medium transition-all duration-200 hover:text-black rounded-lg hover:bg-white group"
                >
                  <svg
                ...
                >
                  ...
                  Customers
                  <svg
                    className="w-4 h-6 ml-auto text-gray-400 group-hover:text-black"
                    xmlns="http://www.w3.org/2000/svg"
                    fill="none"
                    viewBox="0 0 24 24"
                    stroke="currentColor"
